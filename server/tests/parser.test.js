...
describe("Parser tests", () => {
  ...
  it.skip("should return cloudinary urls", async () => {
    const imageUrls = [
      "https://dynamic.thoughtworks.com/clients/logo-44479f965764ede8761332bf52c154bc.png",
      "https://dynamic.thoughtworks.com/clients/pepsi-mtv-indies/pepsi-mtv-indies-mobile-screenshot.png"
    ];
  ...
  it("should replace all urls to cloudinary urls", () => {
    const cloudinaryUrls = { 'https://dynamic.thoughtworks.com/clients/logo-44479f965764ede8761332bf52c154bc.png':
  ...
  it.only("should replace all urls to cloudinary urls in complex html", () => {
    const cloudinaryUrls = { "https://dynamic.thoughtworks.com/clients/logo-44479f965764ede8761332bf52c154bc.png":
    'http://res.cloudinary.com/newzealot/image/upload/v1543481488/pz80s84nu53uveurc1fw.png',
    "https://dynamic.thoughtworks.com/clients/pepsi-mtv-indies/pepsi-mtv-indies-mobile-screenshot.png":
    'http://res.cloudinary.com/newzealot/image/upload/v1543481488/fqfhm2qcowoeufgevgue.png' }
    ...
    expect(updatedHtml).toContain('http://res.cloudinary.com/newzealot/image/upload/v1543481488/pz80s84nu53uveurc1fw.png');
    expect(updatedHtml).toContain('http://res.cloudinary.com/newzealot/image/upload/v1543481488/fqfhm2qcowoeufgevgue.png');
